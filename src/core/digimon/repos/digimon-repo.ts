        ...
        super({
            ...
            createFactory: (map, payload) => {
                const digimon = new DigimonEntity({
                        ...
                        : Object.values(payload.evoInto as any[]).map(
                              (evoInto) => {
                                  const require: DigimonEvoIntoRequire = {
                                      ...
                                      hackerCleared: !evoInto.hackerCleared
                                          ? undefined
                                          : evoInto.hackerCleared,
                                      dlc: !evoInto.dlc
                                          ? undefined
                                          : evoInto.dlc,
                                      changeMode: !evoInto.changeMode
                                          ? undefined
                                          : evoInto.changeMode,
                                      jogress: !evoInto.jogress
                                          ? undefined
                                          : {
                                                id: Object.keys(
                                                    evoInto.jogress,
                                  ...
                                  return {
                                      ...
                                      require: Object.values(require).filter(
                                          (req) => req,
                                      ).length
                                          ? require
                                          : undefined,
                    ...
                    stats: Object.entries(payload.stat as any[]).map(
                        ([lvl, stat]) => ({
                            lvl: parseInt(lvl),
                            hp: stat.hp,
                            sp: stat.sp,
